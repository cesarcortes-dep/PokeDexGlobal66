...
defineProps<{
  active: boolean
  /** Nombre del Pokémon, para el `aria-label`. */
  label: string
}>()
...
<template>
  ...
  >
    ...
    >
      ...
      <!-- Un solo path para los dos estados, para poder animar la transición. -->
      <path
...
.favorite-star {
  ...
  &--active &__heart {
    ...
    stroke: none; // el borde claro sobre el rojo se lee como un halo
  }
